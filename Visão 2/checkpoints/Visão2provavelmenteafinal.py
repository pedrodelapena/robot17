...
while(keepOn):
    ...
    circles=cv2.HoughCircles(bordas,cv.CV_HOUGH_GRADIENT,2,40,param1=50,param2=100,minRadius=5,maxRadius=120)
    ...
    for circle in circles:
        ...
        #96px = 20cm
        acc+=1920.0/circle[2]
    cv2.putText(bordas_color,str(acc/3)+" cm",(0,50), font, 2,(255,255,255),2,cv2.CV_AA)
